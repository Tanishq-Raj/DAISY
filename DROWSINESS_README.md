# Drowsiness Detection for DAISY

This extension adds a drowsiness detection system to DAISY. When the system detects that the player is drowsy (eyes closed for an extended period), it automatically switches the vehicle to self-driving mode.
